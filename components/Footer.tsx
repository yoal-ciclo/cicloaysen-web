    ...
    <footer className="bg-dark text-white">
      <div className="container-max mx-auto px-4 md:px-8 lg:px-16 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Consultoría ambiental especializada en la Patagonia. Conectando territorio, normativa y sustentabilidad.
            </p>
          </div>

          <div>
            <h4 className="font-semibold text-lg mb-4 text-accent">Navegación</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-center gap-2">
                <span>📍</span> Coyhaique, Región de Aysén, Chile
              </li>
              <li className="flex items-center gap-2">
                <span>✉️</span>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-500 text-sm">
          © {year} Ciclo Aysén SpA. Todos los derechos reservados.
        </div>
      </div>
    </footer>
  )
