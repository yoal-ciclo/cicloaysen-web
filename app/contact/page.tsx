...
export const metadata: Metadata = {
  ...
  description: 'Contáctanos para una asesoría ambiental sin compromiso. Gestores de capital natural en la Patagonia chilena.',
}
    ...
    <div>
      <section className="bg-secondary section-padding">
        <div className="container-max mx-auto px-4 md:px-8 lg:px-16">
          <h1 className="text-4xl md:text-5xl font-bold text-dark mb-6">Contáctanos</h1>
          <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
            Escríbenos para una asesoría inicial sin compromiso. Respondemos en menos de 48 horas hábiles.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
                ...
                {[
                  ...
                  <div key={item.title} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {item.link ? (
                        <a href={item.link} className="text-primary text-sm mt-1 block hover:underline">
                          {item.content}
                        </a>
                      ) : (
              ...
              <div className="mt-8 bg-secondary rounded-xl p-6">
                <h3 className="font-semibold text-dark mb-4">Síguenos en redes</h3>
